...
const LEVELS = [
  { 
    id: 1, 
    name: { zh: '紅色的草莓', en: 'Red Strawberry' }, 
    targetColor: '#FF3D00', 
    ...
    details: (
      <g fill="none" stroke="#2D3436" strokeWidth="2">
        <path d="M100,50 L95,30 M100,50 L105,30 M100,50 L80,35 M100,50 L120,35" stroke="#27AE60" strokeWidth="4" />
        <path d="M80,85 Q85,88 80,92 M120,85 Q115,88 120,92 M100,110 Q105,113 100,117 M70,130 Q75,133 70,137 M130,130 Q125,133 130,137 M100,150 Q105,153 100,157" opacity="0.4" />
      </g>
    )
  },
  { 
    id: 2, 
    name: { zh: '黃色的香蕉', en: 'Yellow Banana' }, 
    targetColor: '#FFD600', 
    colorName: { zh: '黃色', en: 'Yellow' },
    objectName: { zh: '香蕉', en: 'Banana' },
    path: "M40,40 C60,40 160,60 160,150 C160,165 150,175 135,165 C110,145 50,80 40,40 Z",
    details: (
      <g fill="none" stroke="#2D3436" strokeWidth="2">
        <path d="M40,40 L30,30" strokeWidth="6" strokeLinecap="round" />
        <path d="M60,60 C80,75 130,95 140,140" opacity="0.2" />
        <path d="M160,150 L170,165" opacity="0.3" />
      </g>
    )
  },
  { 
    id: 3, 
    name: { zh: '綠色的樹葉', en: 'Green Leaf' }, 
    targetColor: '#4CAF50', 
    colorName: { zh: '綠色', en: 'Green' },
    objectName: { zh: '樹葉', en: 'Leaf' },
    path: "M100,30 C60,30 30,70 30,120 C30,170 100,190 100,190 C100,190 170,170 170,120 C170,70 140,30 100,30 Z",
    details: (
      <g fill="none" stroke="#2D3436" strokeWidth="2">
        <path d="M100,30 L100,190" />
        <path d="M100,60 L60,90 M100,90 L50,130 M100,130 L60,170" opacity="0.4" />
        <path d="M100,60 L140,90 M100,90 L150,130 M100,130 L140,170" opacity="0.4" />
      </g>
    )
  },
  { 
    id: 4, 
    name: { zh: '藍色的鯨魚', en: 'Blue Whale' }, 
    targetColor: '#2196F3', 
    colorName: { zh: '藍色', en: 'Blue' },
    objectName: { zh: '鯨魚', en: 'Whale' },
    path: "M30,120 C30,70 110,60 160,90 C190,110 190,150 150,160 C120,170 40,170 30,120 Z",
    details: (
      <g fill="none" stroke="#2D3436" strokeWidth="2">
        <path d="M160,90 L185,75 L185,105 Z" fill="#2D3436" />
        <circle cx="70" cy="110" r="4" fill="#2D3436" />
        <path d="M100,75 Q100,40 85,30 M100,75 Q105,40 120,30" stroke="#81D4FA" strokeWidth="4" />
        <path d="M60,145 Q100,155 140,145" opacity="0.3" />
      </g>
    )
  }
];
...
const App = () => {
  ...
  const calculateCoverage = () => {
    ...
    const currentPercent = (coloredShapePixels / totalShapePixels) * 100;
    setCoverage(currentPercent);

    if (currentPercent >= 80 && !isCompleted) {
      setIsCompleted(true);
      speakBilingual("好棒喔！你完成了！", "Wonderful! You finished it!");
    }
  };
    ...
    <div className="min-h-screen bg-[#FFFBEB] flex flex-col items-center p-4 font-sans select-none touch-none">
      ...
      <div className="relative w-full max-w-md aspect-square bg-white rounded-[40px] shadow-2xl border-[10px] border-white overflow-hidden mb-8">
        ...
        <canvas
          ...
          className="absolute inset-0 w-full h-full p-8 z-10 cursor-crosshair"
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .animate-confetti { animation: confettiFall 2.5s linear infinite; }
      `}} />
    </div>
  );
};
